document.addEventListener("DOMContentLoaded", () => {
    ...
    const channelManager = {
        ...
        loadChannel: async (channelId) => {
            ...
            // --- ตั้งค่า Shaka Player DRM ---
            // Shaka Player จัดการ Clear Key ได้ง่ายกว่ามาก
            const drmConfig = { drm: { clearKeys: {} } }; // เริ่มต้นด้วยการล้างค่า DRM
    ...
    const timeManager = { /* ... full function ... */ };
    function setupCategorySidebar(categories) { /* ... full function ... */ };
    async function fetchAndRenderChannels() { /* ... full function ... */ };

    // (Full implementations for brevity)
    timeManager.update = () => { document.getElementById('datetime-display').textContent = new Date().toLocaleString('th-TH', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' }); };
    ...
    async function init() {
        ...
        // 2. Setup Event Listeners for Custom Controls
